...
```
Read in wot data
fix a few things to be rectangular
fix hair with daniels regex and a few dark commas
fix height look for digits then feet and inches then math with feet and inches
rename columns
...
```
```{r}
write_csv(final_data, "C:\\Users\\deant\\OneDrive\\Desktop\\DSC210\\WoT project\\wot-data\\output\\final_data.csv")
```